...
import type { GeographicLocationAllOf } from './geographicLocationAllOf';
import type { GeographicLocationType } from './geographicLocationType';
import type { Place } from './place';

export type GeographicLocation = Omit<Place, '@type'> &
  Omit<GeographicLocationAllOf, '@type'> & {
