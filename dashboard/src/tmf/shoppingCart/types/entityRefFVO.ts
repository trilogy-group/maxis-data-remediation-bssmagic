...
import type { AddressableFVO } from './addressableFVO';
import type { EntityRefFVOAllOf } from './entityRefFVOAllOf';

export type EntityRefFVO = ExtensibleFVO & AddressableFVO & EntityRefFVOAllOf;
