...
import type { GeographicSubAddressUnitAllOf } from './geographicSubAddressUnitAllOf';
import type { GeographicSubAddressUnitType } from './geographicSubAddressUnitType';

export type GeographicSubAddressUnit = Extensible & GeographicSubAddressUnitAllOf & {
  '@type': GeographicSubAddressUnitType;
};
