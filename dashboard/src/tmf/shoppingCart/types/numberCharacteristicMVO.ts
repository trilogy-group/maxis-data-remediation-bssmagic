...
import type { NumberCharacteristicMVOAllOf } from './numberCharacteristicMVOAllOf';

export type NumberCharacteristicMVO = CharacteristicMVO & NumberCharacteristicMVOAllOf;
