...
export type ShoppingCartDeleteEventType = typeof ShoppingCartDeleteEventType[keyof typeof ShoppingCartDeleteEventType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ShoppingCartDeleteEventType = {
  ShoppingCartDeleteEvent: 'ShoppingCartDeleteEvent',
} as const;
