...
import type { ProductRelationshipMVOAllOf } from './productRelationshipMVOAllOf';

export type ProductRelationshipMVO = Extensible & EntityRef & ProductRelationshipMVOAllOf;
