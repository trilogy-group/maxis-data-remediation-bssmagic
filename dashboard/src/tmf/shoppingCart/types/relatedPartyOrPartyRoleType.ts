...
export type RelatedPartyOrPartyRoleType = typeof RelatedPartyOrPartyRoleType[keyof typeof RelatedPartyOrPartyRoleType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RelatedPartyOrPartyRoleType = {
  RelatedPartyOrPartyRole: 'RelatedPartyOrPartyRole',
} as const;
