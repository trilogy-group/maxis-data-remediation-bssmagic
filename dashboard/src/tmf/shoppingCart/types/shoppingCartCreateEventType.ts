...
export type ShoppingCartCreateEventType = typeof ShoppingCartCreateEventType[keyof typeof ShoppingCartCreateEventType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ShoppingCartCreateEventType = {
  ShoppingCartCreateEvent: 'ShoppingCartCreateEvent',
} as const;
