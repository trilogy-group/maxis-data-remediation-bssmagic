...
import type { CartItemRelationshipAllOf } from './cartItemRelationshipAllOf';
import type { CartItemRelationshipType } from './cartItemRelationshipType';

export type CartItemRelationship = Extensible & CartItemRelationshipAllOf & {
  '@type': CartItemRelationshipType;
};
