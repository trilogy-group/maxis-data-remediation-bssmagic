...
export type GeographicSubAddressUnitType = typeof GeographicSubAddressUnitType[keyof typeof GeographicSubAddressUnitType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GeographicSubAddressUnitType = {
  GeographicSubAddressUnit: 'GeographicSubAddressUnit',
} as const;
