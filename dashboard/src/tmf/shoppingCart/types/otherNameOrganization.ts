...
import type { OtherNameOrganizationAllOf } from './otherNameOrganizationAllOf';
import type { OtherNameOrganizationType } from './otherNameOrganizationType';

export type OtherNameOrganization = Extensible & OtherNameOrganizationAllOf & {
  '@type': OtherNameOrganizationType;
};
