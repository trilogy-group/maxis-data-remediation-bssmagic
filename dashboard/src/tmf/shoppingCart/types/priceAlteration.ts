...
import type { PriceAlterationAllOf } from './priceAlterationAllOf';
import type { PriceAlterationType } from './priceAlterationType';

export type PriceAlteration = Extensible & PriceAlterationAllOf & {
  '@type': PriceAlterationType;
};
