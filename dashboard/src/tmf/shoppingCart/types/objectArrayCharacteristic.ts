...
import type { ObjectArrayCharacteristicAllOf } from './objectArrayCharacteristicAllOf';
import type { ObjectArrayCharacteristicType } from './objectArrayCharacteristicType';

export type ObjectArrayCharacteristic = Characteristic & ObjectArrayCharacteristicAllOf & {
  '@type': ObjectArrayCharacteristicType;
};
