...
import type { NumberArrayCharacteristicAllOf } from './numberArrayCharacteristicAllOf';
import type { NumberArrayCharacteristicType } from './numberArrayCharacteristicType';

export type NumberArrayCharacteristic = Characteristic & NumberArrayCharacteristicAllOf & {
  '@type': NumberArrayCharacteristicType;
};
