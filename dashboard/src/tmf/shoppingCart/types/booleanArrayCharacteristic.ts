...
import type { BooleanArrayCharacteristicAllOf } from './booleanArrayCharacteristicAllOf';

export type BooleanArrayCharacteristic = Characteristic & BooleanArrayCharacteristicAllOf;
