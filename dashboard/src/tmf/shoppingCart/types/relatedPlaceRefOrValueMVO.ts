...
import type { RelatedPlaceRefOrValueMVOAllOf } from './relatedPlaceRefOrValueMVOAllOf';

export type RelatedPlaceRefOrValueMVO = Extensible & RelatedPlaceRefOrValueMVOAllOf;
