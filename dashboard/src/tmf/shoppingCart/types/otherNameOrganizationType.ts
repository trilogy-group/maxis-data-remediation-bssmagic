...
export type OtherNameOrganizationType = typeof OtherNameOrganizationType[keyof typeof OtherNameOrganizationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const OtherNameOrganizationType = {
  OtherNameOrganization: 'OtherNameOrganization',
} as const;
