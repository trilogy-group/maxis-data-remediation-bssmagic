...
import type { ObjectArrayCharacteristicFVOAllOf } from './objectArrayCharacteristicFVOAllOf';

export type ObjectArrayCharacteristicFVO = CharacteristicFVO & ObjectArrayCharacteristicFVOAllOf;
