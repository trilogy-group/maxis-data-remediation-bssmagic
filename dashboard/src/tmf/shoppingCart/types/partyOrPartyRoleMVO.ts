...
import type { PartyRoleRefMVO } from './partyRoleRefMVO';
import type { IndividualMVO } from './individualMVO';
import type { OrganizationMVO } from './organizationMVO';
import type { PartyRoleMVO } from './partyRoleMVO';
import type { SupplierMVO } from './supplierMVO';
import type { BusinessPartnerMVO } from './businessPartnerMVO';
import type { ConsumerMVO } from './consumerMVO';
import type { ProducerMVO } from './producerMVO';

export type PartyOrPartyRoleMVO = PartyRefMVO | PartyRoleRefMVO | IndividualMVO | OrganizationMVO | PartyRoleMVO | SupplierMVO | BusinessPartnerMVO | ConsumerMVO | ProducerMVO;
