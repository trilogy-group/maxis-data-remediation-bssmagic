...
import type { StandardIdentifierAllOf } from './standardIdentifierAllOf';
import type { StandardIdentifierType } from './standardIdentifierType';

export type StandardIdentifier = Entity & StandardIdentifierAllOf & {
