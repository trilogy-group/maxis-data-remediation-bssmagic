...
export type RelatedPartyRefOrPartyRoleRefType = typeof RelatedPartyRefOrPartyRoleRefType[keyof typeof RelatedPartyRefOrPartyRoleRefType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RelatedPartyRefOrPartyRoleRefType = {
  RelatedPartyRefOrPartyRoleRef: 'RelatedPartyRefOrPartyRoleRef',
} as const;
