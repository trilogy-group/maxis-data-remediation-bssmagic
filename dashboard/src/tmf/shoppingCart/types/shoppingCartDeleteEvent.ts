...
import type { ShoppingCartDeleteEventAllOf } from './shoppingCartDeleteEventAllOf';
import type { ShoppingCartDeleteEventType } from './shoppingCartDeleteEventType';

export type ShoppingCartDeleteEvent = Event & ShoppingCartDeleteEventAllOf & {
  '@type': ShoppingCartDeleteEventType;
};
