...
import type { ProductSpecificationRefFVOAllOf } from './productSpecificationRefFVOAllOf';

export type ProductSpecificationRefFVO = EntityRefFVO & ProductSpecificationRefFVOAllOf;
