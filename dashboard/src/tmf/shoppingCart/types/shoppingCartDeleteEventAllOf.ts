 ...
 */
import type { ShoppingCartDeleteEventPayload } from './shoppingCartDeleteEventPayload';

/**
 * ShoppingCartDeleteEvent generic structure
 */
export type ShoppingCartDeleteEventAllOf = {
  event?: ShoppingCartDeleteEventPayload;
};
