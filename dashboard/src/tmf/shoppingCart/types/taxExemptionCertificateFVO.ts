...
import type { TaxExemptionCertificateFVOAllOf } from './taxExemptionCertificateFVOAllOf';

export type TaxExemptionCertificateFVO = ExtensibleFVO & TaxExemptionCertificateFVOAllOf;
