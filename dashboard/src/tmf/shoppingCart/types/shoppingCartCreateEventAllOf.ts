 ...
 */
import type { ShoppingCartCreateEventPayload } from './shoppingCartCreateEventPayload';

/**
 * ShoppingCartCreateEvent generic structure
 */
export type ShoppingCartCreateEventAllOf = {
