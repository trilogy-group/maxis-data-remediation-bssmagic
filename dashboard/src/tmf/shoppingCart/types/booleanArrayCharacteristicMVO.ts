...
import type { BooleanArrayCharacteristicMVOAllOf } from './booleanArrayCharacteristicMVOAllOf';

export type BooleanArrayCharacteristicMVO = CharacteristicMVO & BooleanArrayCharacteristicMVOAllOf;
