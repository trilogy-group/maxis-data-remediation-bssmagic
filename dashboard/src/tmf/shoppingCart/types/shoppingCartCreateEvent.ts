...
import type { ShoppingCartCreateEventAllOf } from './shoppingCartCreateEventAllOf';
import type { ShoppingCartCreateEventType } from './shoppingCartCreateEventType';

export type ShoppingCartCreateEvent = Event & ShoppingCartCreateEventAllOf & {
  '@type': ShoppingCartCreateEventType;
};
