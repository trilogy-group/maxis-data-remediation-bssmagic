...
import type { GeographicSiteRelationshipAllOf } from './geographicSiteRelationshipAllOf';
import type { GeographicSiteRelationshipType } from './geographicSiteRelationshipType';

export type GeographicSiteRelationship = Extensible & GeographicSiteRelationshipAllOf & {
  '@type': GeographicSiteRelationshipType;
};
