...
import type { OrganizationIdentificationMVOAllOf } from './organizationIdentificationMVOAllOf';

export type OrganizationIdentificationMVO = Extensible & OrganizationIdentificationMVOAllOf;
