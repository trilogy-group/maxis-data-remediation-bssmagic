...
export type ShoppingCartAttributeValueChangeEventType = typeof ShoppingCartAttributeValueChangeEventType[keyof typeof ShoppingCartAttributeValueChangeEventType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ShoppingCartAttributeValueChangeEventType = {
  ShoppingCartAttributeValueChangeEvent: 'ShoppingCartAttributeValueChangeEvent',
} as const;
