...
import type { NumberCharacteristicAllOf } from './numberCharacteristicAllOf';
import type { NumberCharacteristicType } from './numberCharacteristicType';

export type NumberCharacteristic = Characteristic & NumberCharacteristicAllOf & {
  '@type': NumberCharacteristicType;
};
