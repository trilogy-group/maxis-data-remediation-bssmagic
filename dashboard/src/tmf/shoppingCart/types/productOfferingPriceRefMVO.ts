...
import type { ProductOfferingPriceRefMVOAllOf } from './productOfferingPriceRefMVOAllOf';

export type ProductOfferingPriceRefMVO = EntityRef & ProductOfferingPriceRefMVOAllOf;
