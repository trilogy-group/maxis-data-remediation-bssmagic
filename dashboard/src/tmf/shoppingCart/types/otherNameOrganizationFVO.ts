...
import type { OtherNameOrganizationFVOAllOf } from './otherNameOrganizationFVOAllOf';

export type OtherNameOrganizationFVO = ExtensibleFVO & OtherNameOrganizationFVOAllOf;
