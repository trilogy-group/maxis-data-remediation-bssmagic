...
import type { CharacteristicRelationshipAllOf } from './characteristicRelationshipAllOf';
import type { CharacteristicRelationshipType } from './characteristicRelationshipType';

export type CharacteristicRelationship = Extensible & CharacteristicRelationshipAllOf & {
  '@type': CharacteristicRelationshipType;
};
