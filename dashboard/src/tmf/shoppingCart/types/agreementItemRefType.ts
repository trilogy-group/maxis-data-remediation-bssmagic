...
export type AgreementItemRefType = typeof AgreementItemRefType[keyof typeof AgreementItemRefType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AgreementItemRefType = {
  AgreementItemRef: 'AgreementItemRef',
} as const;
