...
import type { PartyRoleRefFVO } from './partyRoleRefFVO';
import type { IndividualFVO } from './individualFVO';
import type { OrganizationFVO } from './organizationFVO';
import type { PartyRoleFVO } from './partyRoleFVO';
import type { SupplierFVO } from './supplierFVO';
import type { BusinessPartnerFVO } from './businessPartnerFVO';
import type { ConsumerFVO } from './consumerFVO';
import type { ProducerFVO } from './producerFVO';

export type PartyOrPartyRoleFVO = PartyRefFVO | PartyRoleRefFVO | IndividualFVO | OrganizationFVO | PartyRoleFVO | SupplierFVO | BusinessPartnerFVO | ConsumerFVO | ProducerFVO;
