...
import type { BooleanArrayCharacteristicFVOAllOf } from './booleanArrayCharacteristicFVOAllOf';

export type BooleanArrayCharacteristicFVO = CharacteristicFVO & BooleanArrayCharacteristicFVOAllOf;
