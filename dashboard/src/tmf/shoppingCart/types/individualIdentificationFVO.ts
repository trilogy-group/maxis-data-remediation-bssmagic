...
import type { IndividualIdentificationFVOAllOf } from './individualIdentificationFVOAllOf';

export type IndividualIdentificationFVO = ExtensibleFVO & IndividualIdentificationFVOAllOf;
