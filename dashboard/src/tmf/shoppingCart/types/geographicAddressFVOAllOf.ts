 ...
 */
import type { StandardIdentifierFVO } from './standardIdentifierFVO';
import type { ExternalIdentifierFVO } from './externalIdentifierFVO';
import type { GeographicLocationRefOrValueFVO } from './geographicLocationRefOrValueFVO';
import type { GeographicSubAddressFVO } from './geographicSubAddressFVO';
 ...
 */
export type GeographicAddressFVOAllOf = {
  ...
  countryCode?: StandardIdentifierFVO[];
  ...
  geographicLocation?: GeographicLocationRefOrValueFVO;
  geographicSubAddress?: GeographicSubAddressFVO[];
