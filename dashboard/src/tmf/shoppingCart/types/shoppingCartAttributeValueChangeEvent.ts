...
import type { ShoppingCartAttributeValueChangeEventAllOf } from './shoppingCartAttributeValueChangeEventAllOf';
import type { ShoppingCartAttributeValueChangeEventType } from './shoppingCartAttributeValueChangeEventType';

export type ShoppingCartAttributeValueChangeEvent = Event & ShoppingCartAttributeValueChangeEventAllOf & {
  '@type': ShoppingCartAttributeValueChangeEventType;
};
