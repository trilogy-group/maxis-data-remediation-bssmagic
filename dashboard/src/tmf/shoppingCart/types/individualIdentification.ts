...
import type { IndividualIdentificationAllOf } from './individualIdentificationAllOf';
import type { IndividualIdentificationType } from './individualIdentificationType';

export type IndividualIdentification = Extensible & IndividualIdentificationAllOf & {
  '@type': IndividualIdentificationType;
};
