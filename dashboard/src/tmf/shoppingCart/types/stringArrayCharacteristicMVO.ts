...
import type { StringArrayCharacteristicMVOAllOf } from './stringArrayCharacteristicMVOAllOf';

export type StringArrayCharacteristicMVO = CharacteristicMVO & StringArrayCharacteristicMVOAllOf;
