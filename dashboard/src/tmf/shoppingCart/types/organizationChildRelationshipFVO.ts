...
import type { OrganizationChildRelationshipFVOAllOf } from './organizationChildRelationshipFVOAllOf';

export type OrganizationChildRelationshipFVO = ExtensibleFVO & OrganizationChildRelationshipFVOAllOf;
