 ...
 */
import type { ObjectArrayCharacteristicFVOAllOfValueItem } from './objectArrayCharacteristicFVOAllOfValueItem';

/**
 * A characteristic which value is an array of Object(s).
 */
export type ObjectArrayCharacteristicFVOAllOf = {
  value: ObjectArrayCharacteristicFVOAllOfValueItem[];
};
