...
import type { IndividualIdentificationMVO } from './individualIdentificationMVO';
 ...
 */
export type IndividualMVOAllOf = {
  /** e.g. Baron, Graf, Earl */
  ...
  individualIdentification?: IndividualIdentificationMVO[];
