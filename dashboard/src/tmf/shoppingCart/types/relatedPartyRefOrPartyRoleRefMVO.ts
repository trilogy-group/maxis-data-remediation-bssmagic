...
import type { RelatedPartyRefOrPartyRoleRefMVOAllOf } from './relatedPartyRefOrPartyRoleRefMVOAllOf';

export type RelatedPartyRefOrPartyRoleRefMVO = Extensible & RelatedPartyRefOrPartyRoleRefMVOAllOf;
