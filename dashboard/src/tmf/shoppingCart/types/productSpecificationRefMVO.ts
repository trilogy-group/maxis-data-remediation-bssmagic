...
import type { ProductSpecificationRefMVOAllOf } from './productSpecificationRefMVOAllOf';

export type ProductSpecificationRefMVO = EntityRef & ProductSpecificationRefMVOAllOf;
