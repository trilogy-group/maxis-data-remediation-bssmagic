...
import type { ProductRelationshipAllOf } from './productRelationshipAllOf';
import type { ProductRelationshipType } from './productRelationshipType';

export type ProductRelationship = Extensible & EntityRef & ProductRelationshipAllOf & {
