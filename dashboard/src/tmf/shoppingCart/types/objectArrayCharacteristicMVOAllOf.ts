 ...
 */
import type { ObjectArrayCharacteristicMVOAllOfValueItem } from './objectArrayCharacteristicMVOAllOfValueItem';

/**
 * A characteristic which value is an array of Object(s).
 */
export type ObjectArrayCharacteristicMVOAllOf = {
  value: ObjectArrayCharacteristicMVOAllOfValueItem[];
};
