...
export type GeographicSiteRelationshipType = typeof GeographicSiteRelationshipType[keyof typeof GeographicSiteRelationshipType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GeographicSiteRelationshipType = {
  GeographicSiteRelationship: 'GeographicSiteRelationship',
} as const;
