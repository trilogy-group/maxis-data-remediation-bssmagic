 ...
 */
import type { ShoppingCartMVO } from './shoppingCartMVO';
import type { JsonPatchOperations } from './jsonPatchOperations';

/**
 * The ShoppingCart to be patched
 */
export type ShoppingCartMVOBody = ShoppingCartMVO | JsonPatchOperations;
