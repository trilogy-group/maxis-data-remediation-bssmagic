...
import type { IntegerArrayCharacteristicAllOf } from './integerArrayCharacteristicAllOf';
import type { IntegerArrayCharacteristicType } from './integerArrayCharacteristicType';

export type IntegerArrayCharacteristic = Characteristic & IntegerArrayCharacteristicAllOf & {
  '@type': IntegerArrayCharacteristicType;
};
