...
import type { OrganizationParentRelationshipAllOf } from './organizationParentRelationshipAllOf';
import type { OrganizationParentRelationshipType } from './organizationParentRelationshipType';

export type OrganizationParentRelationship = Extensible & OrganizationParentRelationshipAllOf & {
  '@type': OrganizationParentRelationshipType;
};
