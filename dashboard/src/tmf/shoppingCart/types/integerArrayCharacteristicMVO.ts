...
import type { IntegerArrayCharacteristicMVOAllOf } from './integerArrayCharacteristicMVOAllOf';

export type IntegerArrayCharacteristicMVO = CharacteristicMVO & IntegerArrayCharacteristicMVOAllOf;
