 ...
 */
import type { ShoppingCartAttributeValueChangeEventPayload } from './shoppingCartAttributeValueChangeEventPayload';

/**
 * ShoppingCartAttributeValueChangeEvent generic structure
 */
export type ShoppingCartAttributeValueChangeEventAllOf = {
  event?: ShoppingCartAttributeValueChangeEventPayload;
};
