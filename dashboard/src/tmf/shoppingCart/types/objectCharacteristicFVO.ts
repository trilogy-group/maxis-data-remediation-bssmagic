...
import type { ObjectCharacteristicFVOAllOf } from './objectCharacteristicFVOAllOf';

export type ObjectCharacteristicFVO = CharacteristicFVO & ObjectCharacteristicFVOAllOf;
