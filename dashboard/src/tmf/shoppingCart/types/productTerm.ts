...
import type { ProductTermAllOf } from './productTermAllOf';
import type { ProductTermType } from './productTermType';

export type ProductTerm = Extensible & ProductTermAllOf & {
  '@type': ProductTermType;
};
