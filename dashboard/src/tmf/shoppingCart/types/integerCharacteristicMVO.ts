...
import type { IntegerCharacteristicMVOAllOf } from './integerCharacteristicMVOAllOf';

export type IntegerCharacteristicMVO = CharacteristicMVO & IntegerCharacteristicMVOAllOf;
