...
import type { CharacteristicRelationshipMVOAllOf } from './characteristicRelationshipMVOAllOf';

export type CharacteristicRelationshipMVO = Extensible & CharacteristicRelationshipMVOAllOf;
