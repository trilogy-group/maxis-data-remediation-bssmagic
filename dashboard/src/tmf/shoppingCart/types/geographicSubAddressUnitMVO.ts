...
import type { GeographicSubAddressUnitMVOAllOf } from './geographicSubAddressUnitMVOAllOf';

export type GeographicSubAddressUnitMVO = Extensible & GeographicSubAddressUnitMVOAllOf;
