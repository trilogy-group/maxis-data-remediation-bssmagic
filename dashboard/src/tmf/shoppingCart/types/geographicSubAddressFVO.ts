 ...
 */
import type { EntityFVO } from './entityFVO';
import type { GeographicSubAddressFVOAllOf } from './geographicSubAddressFVOAllOf';

export type GeographicSubAddressFVO = EntityFVO & GeographicSubAddressFVOAllOf;
