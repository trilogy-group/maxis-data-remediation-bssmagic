 ...
 */
import type { ExtensibleFVO } from './extensibleFVO';
import type { EntityRefFVO } from './entityRefFVO';
import type { ProductRelationshipFVOAllOf } from './productRelationshipFVOAllOf';

export type ProductRelationshipFVO = ExtensibleFVO & EntityRefFVO & ProductRelationshipFVOAllOf;
