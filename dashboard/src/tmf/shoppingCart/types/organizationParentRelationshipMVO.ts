...
import type { OrganizationParentRelationshipMVOAllOf } from './organizationParentRelationshipMVOAllOf';

export type OrganizationParentRelationshipMVO = Extensible & OrganizationParentRelationshipMVOAllOf;
