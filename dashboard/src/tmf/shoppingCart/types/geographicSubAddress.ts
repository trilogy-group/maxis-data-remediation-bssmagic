...
import type { GeographicSubAddressAllOf } from './geographicSubAddressAllOf';
import type { GeographicSubAddressType } from './geographicSubAddressType';

export type GeographicSubAddress = Entity & GeographicSubAddressAllOf & {
