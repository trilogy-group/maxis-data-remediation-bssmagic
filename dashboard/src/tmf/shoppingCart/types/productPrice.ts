...
import type { ProductPriceAllOf } from './productPriceAllOf';
import type { ProductPriceType } from './productPriceType';

export type ProductPrice = Extensible & ProductPriceAllOf & {
