 ...
 */
import type { ObjectCharacteristicMVOAllOfValue } from './objectCharacteristicMVOAllOfValue';

/**
 * A characteristic which value is a Object.
 */
export type ObjectCharacteristicMVOAllOf = {
  /** Value of the characteristic */
  value: ObjectCharacteristicMVOAllOfValue;
};
