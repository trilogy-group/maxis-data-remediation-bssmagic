...
import type { TaxDefinitionAllOf } from './taxDefinitionAllOf';
import type { TaxDefinitionType } from './taxDefinitionType';

export type TaxDefinition = Extensible & TaxDefinitionAllOf & {
  '@type': TaxDefinitionType;
};
