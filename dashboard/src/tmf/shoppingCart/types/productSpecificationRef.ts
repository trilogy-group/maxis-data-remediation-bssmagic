...
import type { ProductSpecificationRefAllOf } from './productSpecificationRefAllOf';
import type { ProductSpecificationRefType } from './productSpecificationRefType';

export type ProductSpecificationRef = EntityRef & ProductSpecificationRefAllOf & {
  '@type': ProductSpecificationRefType;
};
