...
import type { StringArrayCharacteristicFVOAllOf } from './stringArrayCharacteristicFVOAllOf';

export type StringArrayCharacteristicFVO = CharacteristicFVO & StringArrayCharacteristicFVOAllOf;
