 ...
 */
import type { ShoppingCartDeleteEvent } from './shoppingCartDeleteEvent';

/**
 * ShoppingCart delete Event payload
 */
export type ShoppingCartDeleteEventBody = ShoppingCartDeleteEvent;
