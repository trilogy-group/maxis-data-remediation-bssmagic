...
import type { CartItemRelationshipFVOAllOf } from './cartItemRelationshipFVOAllOf';

export type CartItemRelationshipFVO = ExtensibleFVO & CartItemRelationshipFVOAllOf;
