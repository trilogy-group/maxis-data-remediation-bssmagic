...
import type { IndividualIdentificationMVOAllOf } from './individualIdentificationMVOAllOf';

export type IndividualIdentificationMVO = Extensible & IndividualIdentificationMVOAllOf;
