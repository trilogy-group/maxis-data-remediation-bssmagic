 ...
 */
import type { ObjectCharacteristicFVOAllOfValue } from './objectCharacteristicFVOAllOfValue';

/**
 * A characteristic which value is a Object.
 */
export type ObjectCharacteristicFVOAllOf = {
  /** Value of the characteristic */
  value: ObjectCharacteristicFVOAllOfValue;
};
