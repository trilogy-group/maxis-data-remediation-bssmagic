...
import type { PartyRoleSpecificationRefType } from './partyRoleSpecificationRefType';
 ...
 */
export type PartyRoleSpecificationRef = EntityRef & {
  '@type': PartyRoleSpecificationRefType;
};
