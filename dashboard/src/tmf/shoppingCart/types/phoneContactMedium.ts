...
import type { PhoneContactMediumAllOf } from './phoneContactMediumAllOf';
import type { PhoneContactMediumType } from './phoneContactMediumType';

export type PhoneContactMedium = ContactMedium & PhoneContactMediumAllOf & {
  '@type': PhoneContactMediumType;
};
