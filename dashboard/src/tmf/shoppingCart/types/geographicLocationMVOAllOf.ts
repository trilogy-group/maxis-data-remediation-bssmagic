 ...
 */
import type { GeographicLocationMVOAllOfType } from './geographicLocationMVOAllOfType';
 ...
 */
export type GeographicLocationMVOAllOf = {
  /** The name of the GeoJSON structure used in the geometry attribute */
  '@type'?: GeographicLocationMVOAllOfType;
