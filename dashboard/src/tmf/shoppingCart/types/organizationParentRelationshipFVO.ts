...
import type { OrganizationParentRelationshipFVOAllOf } from './organizationParentRelationshipFVOAllOf';

export type OrganizationParentRelationshipFVO = ExtensibleFVO & OrganizationParentRelationshipFVOAllOf;
