...
import type { CreditProfileAllOf } from './creditProfileAllOf';
import type { CreditProfileType } from './creditProfileType';

export type CreditProfile = Entity & CreditProfileAllOf & {
  '@type': CreditProfileType;
};
