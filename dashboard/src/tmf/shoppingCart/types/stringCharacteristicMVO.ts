...
import type { StringCharacteristicMVOAllOf } from './stringCharacteristicMVOAllOf';

export type StringCharacteristicMVO = CharacteristicMVO & StringCharacteristicMVOAllOf;
