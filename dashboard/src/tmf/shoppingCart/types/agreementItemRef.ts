...
import type { AgreementItemRefAllOf } from './agreementItemRefAllOf';
import type { AgreementItemRefType } from './agreementItemRefType';

export type AgreementItemRef = Extensible & AgreementItemRefAllOf & {
  '@type': AgreementItemRefType;
};
