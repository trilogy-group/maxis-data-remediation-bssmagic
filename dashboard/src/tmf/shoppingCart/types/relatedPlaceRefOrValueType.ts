...
export type RelatedPlaceRefOrValueType = typeof RelatedPlaceRefOrValueType[keyof typeof RelatedPlaceRefOrValueType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RelatedPlaceRefOrValueType = {
  RelatedPlaceRefOrValue: 'RelatedPlaceRefOrValue',
} as const;
