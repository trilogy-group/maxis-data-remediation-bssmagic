...
import type { BillingAccountRefFVOAllOf } from './billingAccountRefFVOAllOf';

export type BillingAccountRefFVO = ExtensibleFVO & EntityRefFVO & BillingAccountRefFVOAllOf;
