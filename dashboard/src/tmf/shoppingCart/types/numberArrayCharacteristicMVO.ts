...
import type { NumberArrayCharacteristicMVOAllOf } from './numberArrayCharacteristicMVOAllOf';

export type NumberArrayCharacteristicMVO = CharacteristicMVO & NumberArrayCharacteristicMVOAllOf;
