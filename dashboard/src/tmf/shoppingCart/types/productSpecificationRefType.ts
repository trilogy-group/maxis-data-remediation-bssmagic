...
export type ProductSpecificationRefType = typeof ProductSpecificationRefType[keyof typeof ProductSpecificationRefType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ProductSpecificationRefType = {
  ProductSpecificationRef: 'ProductSpecificationRef',
} as const;
