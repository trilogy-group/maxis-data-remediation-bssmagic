...
import type { PartyCreditProfileAllOf } from './partyCreditProfileAllOf';
import type { PartyCreditProfileType } from './partyCreditProfileType';

export type PartyCreditProfile = Entity & PartyCreditProfileAllOf & {
  '@type': PartyCreditProfileType;
};
