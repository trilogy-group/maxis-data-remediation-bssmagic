...
import type { RelatedOrderItemAllOf } from './relatedOrderItemAllOf';
import type { RelatedOrderItemType } from './relatedOrderItemType';

export type RelatedOrderItem = Extensible & RelatedOrderItemAllOf & {
  '@type': RelatedOrderItemType;
};
