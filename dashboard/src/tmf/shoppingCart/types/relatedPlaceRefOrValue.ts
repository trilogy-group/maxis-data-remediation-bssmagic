...
import type { RelatedPlaceRefOrValueAllOf } from './relatedPlaceRefOrValueAllOf';
import type { RelatedPlaceRefOrValueType } from './relatedPlaceRefOrValueType';

export type RelatedPlaceRefOrValue = Extensible & RelatedPlaceRefOrValueAllOf & {
