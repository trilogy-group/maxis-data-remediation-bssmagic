...
import type { ObjectCharacteristicMVOAllOf } from './objectCharacteristicMVOAllOf';

export type ObjectCharacteristicMVO = CharacteristicMVO & ObjectCharacteristicMVOAllOf;
