 ...
 */
import type { ObjectArrayCharacteristicAllOfValueItem } from './objectArrayCharacteristicAllOfValueItem';

/**
 * A characteristic which value is an array of Object(s).
 */
export type ObjectArrayCharacteristicAllOf = {
  value?: ObjectArrayCharacteristicAllOfValueItem[];
};
