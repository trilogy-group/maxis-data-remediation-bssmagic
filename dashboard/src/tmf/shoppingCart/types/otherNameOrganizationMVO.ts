...
import type { OtherNameOrganizationMVOAllOf } from './otherNameOrganizationMVOAllOf';

export type OtherNameOrganizationMVO = Extensible & OtherNameOrganizationMVOAllOf;
