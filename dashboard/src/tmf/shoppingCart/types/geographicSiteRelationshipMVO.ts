...
import type { GeographicSiteRelationshipMVOAllOf } from './geographicSiteRelationshipMVOAllOf';

export type GeographicSiteRelationshipMVO = Extensible & GeographicSiteRelationshipMVOAllOf;
