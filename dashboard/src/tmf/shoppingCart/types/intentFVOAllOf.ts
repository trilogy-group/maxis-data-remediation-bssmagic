 ...
 */
import type { AttachmentRefOrValueFVO } from './attachmentRefOrValueFVO';
import type { CharacteristicFVO } from './characteristicFVO';
import type { ExpressionFVO } from './expressionFVO';
import type { EntityRelationshipFVO } from './entityRelationshipFVO';
...
export type IntentFVOAllOf = {
  ...
  description?: string;
  expression?: ExpressionFVO;
  /** A list of intents related to this intent */
  intentRelationship?: EntityRelationshipFVO[];
  intentSpecification?: EntityRefFVO;
