...
import type { ProductOfferingPriceRefAllOf } from './productOfferingPriceRefAllOf';
import type { ProductOfferingPriceRefType } from './productOfferingPriceRefType';

export type ProductOfferingPriceRef = EntityRef & ProductOfferingPriceRefAllOf & {
  '@type': ProductOfferingPriceRefType;
};
