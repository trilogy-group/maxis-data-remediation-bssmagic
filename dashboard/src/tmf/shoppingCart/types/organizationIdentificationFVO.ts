...
import type { OrganizationIdentificationFVOAllOf } from './organizationIdentificationFVOAllOf';

export type OrganizationIdentificationFVO = ExtensibleFVO & OrganizationIdentificationFVOAllOf;
