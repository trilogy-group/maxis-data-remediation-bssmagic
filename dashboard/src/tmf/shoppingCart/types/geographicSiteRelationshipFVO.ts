...
import type { GeographicSiteRelationshipFVOAllOf } from './geographicSiteRelationshipFVOAllOf';

export type GeographicSiteRelationshipFVO = ExtensibleFVO & GeographicSiteRelationshipFVOAllOf;
