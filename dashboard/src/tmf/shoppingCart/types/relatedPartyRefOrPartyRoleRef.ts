...
import type { RelatedPartyRefOrPartyRoleRefAllOf } from './relatedPartyRefOrPartyRoleRefAllOf';
import type { RelatedPartyRefOrPartyRoleRefType } from './relatedPartyRefOrPartyRoleRefType';

export type RelatedPartyRefOrPartyRoleRef = Extensible & RelatedPartyRefOrPartyRoleRefAllOf & {
  '@type': RelatedPartyRefOrPartyRoleRefType;
};
