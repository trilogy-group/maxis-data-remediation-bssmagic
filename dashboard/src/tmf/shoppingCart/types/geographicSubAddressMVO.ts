 ...
 */
import type { EntityMVO } from './entityMVO';
import type { GeographicSubAddressMVOAllOf } from './geographicSubAddressMVOAllOf';

export type GeographicSubAddressMVO = EntityMVO & GeographicSubAddressMVOAllOf;
