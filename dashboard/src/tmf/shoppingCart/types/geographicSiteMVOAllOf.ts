 ...
 */
import type { CalendarPeriodMVO } from './calendarPeriodMVO';
import type { ExternalIdentifierMVO } from './externalIdentifierMVO';
import type { PlaceRefOrValueMVO } from './placeRefOrValueMVO';
import type { RelatedPartyOrPartyRoleMVO } from './relatedPartyOrPartyRoleMVO';
import type { GeographicSiteRelationshipMVO } from './geographicSiteRelationshipMVO';

export type GeographicSiteMVOAllOf = {
  calendar?: CalendarPeriodMVO[];
  ...
  siteRelationship?: GeographicSiteRelationshipMVO[];
