...
import type { ContactMediumAllOf } from './contactMediumAllOf';
import type { ContactMediumType } from './contactMediumType';

export type ContactMedium = Extensible & ContactMediumAllOf & {
