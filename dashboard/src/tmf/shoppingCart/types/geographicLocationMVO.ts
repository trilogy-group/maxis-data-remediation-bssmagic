 ...
 */
import type { PlaceMVO } from './placeMVO';
import type { GeographicLocationMVOAllOf } from './geographicLocationMVOAllOf';

export type GeographicLocationMVO = PlaceMVO & GeographicLocationMVOAllOf;
