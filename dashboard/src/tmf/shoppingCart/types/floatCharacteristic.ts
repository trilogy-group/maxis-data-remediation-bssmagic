...
import type { FloatCharacteristicAllOf } from './floatCharacteristicAllOf';
import type { FloatCharacteristicType } from './floatCharacteristicType';

export type FloatCharacteristic = Characteristic & FloatCharacteristicAllOf & {
  '@type': FloatCharacteristicType;
};
