...
import type { GeographicAddressAllOf } from './geographicAddressAllOf';
import type { GeographicAddressType } from './geographicAddressType';
import type { Place } from './place';

export type GeographicAddress = Omit<Place, '@type'> &
  GeographicAddressAllOf & {
    '@type': GeographicAddressType;
  };
