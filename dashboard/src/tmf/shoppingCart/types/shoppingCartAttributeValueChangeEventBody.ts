 ...
 */
import type { ShoppingCartAttributeValueChangeEvent } from './shoppingCartAttributeValueChangeEvent';

/**
 * ShoppingCart attributeValueChange Event payload
 */
export type ShoppingCartAttributeValueChangeEventBody = ShoppingCartAttributeValueChangeEvent;
