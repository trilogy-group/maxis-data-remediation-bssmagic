...
import type { AttachmentRefAllOf } from './attachmentRefAllOf';
import type { AttachmentRefType } from './attachmentRefType';

export type AttachmentRef = EntityRef & AttachmentRefAllOf & {
