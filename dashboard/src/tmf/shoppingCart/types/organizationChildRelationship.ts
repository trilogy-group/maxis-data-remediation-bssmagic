...
import type { OrganizationChildRelationshipAllOf } from './organizationChildRelationshipAllOf';
import type { OrganizationChildRelationshipType } from './organizationChildRelationshipType';

export type OrganizationChildRelationship = Extensible & OrganizationChildRelationshipAllOf & {
  '@type': OrganizationChildRelationshipType;
};
