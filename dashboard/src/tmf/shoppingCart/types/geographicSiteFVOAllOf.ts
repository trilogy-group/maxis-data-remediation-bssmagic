 ...
 */
import type { CalendarPeriodFVO } from './calendarPeriodFVO';
import type { ExternalIdentifierFVO } from './externalIdentifierFVO';
import type { PlaceRefOrValueFVO } from './placeRefOrValueFVO';
import type { RelatedPartyOrPartyRoleFVO } from './relatedPartyOrPartyRoleFVO';
import type { GeographicSiteRelationshipFVO } from './geographicSiteRelationshipFVO';

export type GeographicSiteFVOAllOf = {
  calendar?: CalendarPeriodFVO[];
  ...
  siteRelationship?: GeographicSiteRelationshipFVO[];
