...
import type { ProductOfferingPriceRefFVOAllOf } from './productOfferingPriceRefFVOAllOf';

export type ProductOfferingPriceRefFVO = EntityRefFVO & ProductOfferingPriceRefFVOAllOf;
