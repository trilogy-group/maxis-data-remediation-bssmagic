...
import type { PartyRoleRefAllOf } from './partyRoleRefAllOf';
import type { PartyRoleRefType } from './partyRoleRefType';

export type PartyRoleRef = EntityRef & PartyRoleRefAllOf & {
  '@type': PartyRoleRefType;
};
