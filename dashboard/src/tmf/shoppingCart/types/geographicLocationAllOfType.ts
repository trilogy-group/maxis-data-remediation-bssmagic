 ...
 */
export type GeographicLocationAllOfType = typeof GeographicLocationAllOfType[keyof typeof GeographicLocationAllOfType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GeographicLocationAllOfType = {
