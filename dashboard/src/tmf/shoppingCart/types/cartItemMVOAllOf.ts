...
import type { CartItemMVO } from './cartItemMVO';
import type { CartItemRelationshipMVO } from './cartItemRelationshipMVO';
import type { CartPriceMVO } from './cartPriceMVO';
import type { CartTermMVO } from './cartTermMVO';
import type { NoteMVO } from './noteMVO';
 ...
 */
export type CartItemMVOAllOf = {
  action?: CartItemActionType;
  cartItem?: CartItemMVO[];
  cartItemRelationship?: CartItemRelationshipMVO[];
  /** Identifier of the cart item (generally it is a sequence number 01, 02, 03, ...) in the shopping cart */
  id?: string;
  itemPrice?: CartPriceMVO[];
  itemTerm?: CartTermMVO[];
  note?: NoteMVO[];
