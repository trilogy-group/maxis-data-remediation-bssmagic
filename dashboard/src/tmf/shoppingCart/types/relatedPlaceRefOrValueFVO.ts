...
import type { RelatedPlaceRefOrValueFVOAllOf } from './relatedPlaceRefOrValueFVOAllOf';

export type RelatedPlaceRefOrValueFVO = ExtensibleFVO & RelatedPlaceRefOrValueFVOAllOf;
