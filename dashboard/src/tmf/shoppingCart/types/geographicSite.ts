...
import type { GeographicSiteAllOf } from './geographicSiteAllOf';
import type { GeographicSiteType } from './geographicSiteType';
import type { Place } from './place';

export type GeographicSite = Omit<Place, '@type'> &
  GeographicSiteAllOf & {
    '@type': GeographicSiteType;
  };
