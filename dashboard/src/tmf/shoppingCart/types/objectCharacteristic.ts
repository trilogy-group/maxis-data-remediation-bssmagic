...
import type { ObjectCharacteristicAllOf } from './objectCharacteristicAllOf';
import type { ObjectCharacteristicType } from './objectCharacteristicType';

export type ObjectCharacteristic = Characteristic & ObjectCharacteristicAllOf & {
  '@type': ObjectCharacteristicType;
};
