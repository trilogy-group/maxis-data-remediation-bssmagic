...
import type { EmailContactMediumAllOf } from './emailContactMediumAllOf';
import type { EmailContactMediumType } from './emailContactMediumType';

export type EmailContactMedium = ContactMedium & EmailContactMediumAllOf & {
  '@type': EmailContactMediumType;
};
