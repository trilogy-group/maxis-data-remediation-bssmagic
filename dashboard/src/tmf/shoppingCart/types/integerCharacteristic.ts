...
import type { IntegerCharacteristicAllOf } from './integerCharacteristicAllOf';
import type { IntegerCharacteristicType } from './integerCharacteristicType';

export type IntegerCharacteristic = Characteristic & IntegerCharacteristicAllOf & {
  '@type': IntegerCharacteristicType;
};
