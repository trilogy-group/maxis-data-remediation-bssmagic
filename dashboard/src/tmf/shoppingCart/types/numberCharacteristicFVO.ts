...
import type { NumberCharacteristicFVOAllOf } from './numberCharacteristicFVOAllOf';

export type NumberCharacteristicFVO = CharacteristicFVO & NumberCharacteristicFVOAllOf;
