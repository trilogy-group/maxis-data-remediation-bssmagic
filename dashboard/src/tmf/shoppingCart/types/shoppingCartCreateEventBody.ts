 ...
 */
import type { ShoppingCartCreateEvent } from './shoppingCartCreateEvent';

/**
 * ShoppingCart create Event payload
 */
export type ShoppingCartCreateEventBody = ShoppingCartCreateEvent;
