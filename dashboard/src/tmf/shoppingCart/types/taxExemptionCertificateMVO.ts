...
import type { TaxExemptionCertificateMVOAllOf } from './taxExemptionCertificateMVOAllOf';

export type TaxExemptionCertificateMVO = Extensible & TaxExemptionCertificateMVOAllOf;
