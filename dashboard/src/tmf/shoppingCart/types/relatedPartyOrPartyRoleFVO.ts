...
import type { RelatedPartyOrPartyRoleFVOAllOf } from './relatedPartyOrPartyRoleFVOAllOf';

export type RelatedPartyOrPartyRoleFVO = ExtensibleFVO & RelatedPartyOrPartyRoleFVOAllOf;
