...
import type { PartyCreditProfileMVO } from './partyCreditProfileMVO';
import type { ExternalIdentifierMVO } from './externalIdentifierMVO';
...
export type PartyMVOAllOf = {
  ...
  creditRating?: PartyCreditProfileMVO[];
  ...
  externalReference?: ExternalIdentifierMVO[];
  /** List of additional characteristics that a Party can take on. */
  partyCharacteristic?: CharacteristicMVO[];
  ...
  taxExemptionCertificate?: TaxExemptionCertificateMVO[];
};
