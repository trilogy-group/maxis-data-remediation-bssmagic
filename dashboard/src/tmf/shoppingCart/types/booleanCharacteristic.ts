...
import type { BooleanCharacteristicAllOf } from './booleanCharacteristicAllOf';
import type { BooleanCharacteristicType } from './booleanCharacteristicType';

export type BooleanCharacteristic = Characteristic & BooleanCharacteristicAllOf & {
  '@type': BooleanCharacteristicType;
};
