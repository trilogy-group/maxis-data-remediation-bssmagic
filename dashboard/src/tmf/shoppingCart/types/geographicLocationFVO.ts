 ...
 */
import type { PlaceFVO } from './placeFVO';
import type { GeographicLocationFVOAllOf } from './geographicLocationFVOAllOf';

export type GeographicLocationFVO = PlaceFVO & GeographicLocationFVOAllOf;
