...
import type { OrganizationChildRelationshipFVO } from './organizationChildRelationshipFVO';
import type { OrganizationIdentificationFVO } from './organizationIdentificationFVO';
import type { OrganizationParentRelationshipFVO } from './organizationParentRelationshipFVO';
import type { OtherNameOrganizationFVO } from './otherNameOrganizationFVO';
 ...
 */
export type OrganizationFVOAllOf = {
  ...
  organizationChildRelationship?: OrganizationChildRelationshipFVO[];
  /** List of official identifiers given to the organization, for example company number in the registry of companies */
  organizationIdentification?: OrganizationIdentificationFVO[];
  organizationParentRelationship?: OrganizationParentRelationshipFVO;
  /** Type of Organization (company, department...) */
  organizationType?: string;
  /** List of additional names by which the organization is known */
  otherName?: OtherNameOrganizationFVO[];
