...
import type { RelatedPartyOrPartyRoleAllOf } from './relatedPartyOrPartyRoleAllOf';
import type { RelatedPartyOrPartyRoleType } from './relatedPartyOrPartyRoleType';

export type RelatedPartyOrPartyRole = Extensible & RelatedPartyOrPartyRoleAllOf & {
  '@type': RelatedPartyOrPartyRoleType;
};
