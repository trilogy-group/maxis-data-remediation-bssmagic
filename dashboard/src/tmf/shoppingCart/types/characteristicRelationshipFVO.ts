...
import type { CharacteristicRelationshipFVOAllOf } from './characteristicRelationshipFVOAllOf';

export type CharacteristicRelationshipFVO = ExtensibleFVO & CharacteristicRelationshipFVOAllOf;
