 ...
 */
import type { CartItemActionType } from './cartItemActionType';
import type { CartItemFVO } from './cartItemFVO';
import type { CartItemRelationshipFVO } from './cartItemRelationshipFVO';
import type { CartPriceFVO } from './cartPriceFVO';
import type { CartTermFVO } from './cartTermFVO';
import type { NoteFVO } from './noteFVO';
import type { ProductRefOrValueFVO } from './productRefOrValueFVO';
import type { ProductOfferingRefFVO } from './productOfferingRefFVO';
import type { CartItemStatusType } from './cartItemStatusType';
 ...
 */
export type CartItemFVOAllOf = {
  action?: CartItemActionType;
  cartItem?: CartItemFVO[];
  cartItemRelationship?: CartItemRelationshipFVO[];
  /** Identifier of the cart item (generally it is a sequence number 01, 02, 03, ...) in the shopping cart */
  id?: string;
  itemPrice?: CartPriceFVO[];
  itemTerm?: CartTermFVO[];
  note?: NoteFVO[];
