...
import type { ProductOfferingRefAllOf } from './productOfferingRefAllOf';
import type { ProductOfferingRefType } from './productOfferingRefType';

export type ProductOfferingRef = EntityRef & ProductOfferingRefAllOf & {
  '@type': ProductOfferingRefType;
};
