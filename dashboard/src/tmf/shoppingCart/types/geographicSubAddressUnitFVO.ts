...
import type { GeographicSubAddressUnitFVOAllOf } from './geographicSubAddressUnitFVOAllOf';

export type GeographicSubAddressUnitFVO = ExtensibleFVO & GeographicSubAddressUnitFVOAllOf;
