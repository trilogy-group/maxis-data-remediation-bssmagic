...
import type { BillingAccountRefAllOf } from './billingAccountRefAllOf';
import type { BillingAccountRefType } from './billingAccountRefType';

export type BillingAccountRef = Extensible & EntityRef & BillingAccountRefAllOf & {
  '@type': BillingAccountRefType;
};
