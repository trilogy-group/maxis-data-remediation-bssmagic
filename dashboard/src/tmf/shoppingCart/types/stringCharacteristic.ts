...
import type { StringCharacteristicAllOf } from './stringCharacteristicAllOf';
import type { StringCharacteristicType } from './stringCharacteristicType';

export type StringCharacteristic = Characteristic & StringCharacteristicAllOf & {
  '@type': StringCharacteristicType;
};
