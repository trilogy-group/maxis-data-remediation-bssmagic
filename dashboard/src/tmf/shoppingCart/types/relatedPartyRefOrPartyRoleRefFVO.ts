...
import type { RelatedPartyRefOrPartyRoleRefFVOAllOf } from './relatedPartyRefOrPartyRoleRefFVOAllOf';

export type RelatedPartyRefOrPartyRoleRefFVO = ExtensibleFVO & RelatedPartyRefOrPartyRoleRefFVOAllOf;
