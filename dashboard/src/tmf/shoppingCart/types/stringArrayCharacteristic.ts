...
import type { StringArrayCharacteristicAllOf } from './stringArrayCharacteristicAllOf';
import type { StringArrayCharacteristicType } from './stringArrayCharacteristicType';

export type StringArrayCharacteristic = Characteristic & StringArrayCharacteristicAllOf & {
  '@type': StringArrayCharacteristicType;
};
