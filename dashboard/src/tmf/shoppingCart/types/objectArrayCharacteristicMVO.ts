...
import type { ObjectArrayCharacteristicMVOAllOf } from './objectArrayCharacteristicMVOAllOf';

export type ObjectArrayCharacteristicMVO = CharacteristicMVO & ObjectArrayCharacteristicMVOAllOf;
