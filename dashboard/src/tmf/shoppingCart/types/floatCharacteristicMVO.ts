...
import type { FloatCharacteristicMVOAllOf } from './floatCharacteristicMVOAllOf';

export type FloatCharacteristicMVO = CharacteristicMVO & FloatCharacteristicMVOAllOf;
