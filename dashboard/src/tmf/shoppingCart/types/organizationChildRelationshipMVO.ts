...
import type { OrganizationChildRelationshipMVOAllOf } from './organizationChildRelationshipMVOAllOf';

export type OrganizationChildRelationshipMVO = Extensible & OrganizationChildRelationshipMVOAllOf;
