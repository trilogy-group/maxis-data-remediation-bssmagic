...
import type { RelatedPartyOrPartyRoleMVOAllOf } from './relatedPartyOrPartyRoleMVOAllOf';

export type RelatedPartyOrPartyRoleMVO = Extensible & RelatedPartyOrPartyRoleMVOAllOf;
