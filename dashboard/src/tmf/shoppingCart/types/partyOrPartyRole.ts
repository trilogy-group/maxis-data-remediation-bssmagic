...
import type { PartyRoleRef } from './partyRoleRef';
import type { Individual } from './individual';
import type { Organization } from './organization';
import type { PartyRole } from './partyRole';
import type { Supplier } from './supplier';
import type { BusinessPartner } from './businessPartner';
import type { Consumer } from './consumer';
import type { Producer } from './producer';

export type PartyOrPartyRole = PartyRef | PartyRoleRef | Individual | Organization | PartyRole | Supplier | BusinessPartner | Consumer | Producer;
